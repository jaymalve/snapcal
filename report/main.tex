...
\begin{figure}
  ...
  \caption{SnapCal frontend showing an uploaded meal image, predicted calories, the preset portion selector, and the segmentation comparison toggle.}
  \Description{Screenshot of the SnapCal frontend after predicting a hamburger meal. The interface shows the meal image, the detected class, estimated calories, the selected standard serving option, and the segmentation comparison checkbox enabled.}
  \label{fig:frontend}
\end{figure}
